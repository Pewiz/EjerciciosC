// 16. Una empresa que se dedica a la venta de desinfectantes necesita un programa para
...
// total, cantidad de litros vendidos del artículo 1 y cuantas facturas se emitieron de
// más de $600.